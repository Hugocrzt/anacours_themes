...
<div>
	<main>
            ...
            <div class="home-landing-bandeau">
				<div class="home-landing-bandeau-text-wrapper">
					<div class="home-landing-bandeau-title-container">
						<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/12/A-DEUX.svg" alt="">
						<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/12/ON-APPREND-MIEUX.svg" alt="">
					</div>
					<p>Spécialiste du soutien scolaire, Anacours compte désormais plus de 12 000 élèves chaque année et les accompagne avec un soutien scolaire individualisé.</p>
				</div>
				<div class="home-landing-bandeau-search-wrapper">
					<p>Quel est votre besoin ?</p>
					<div class="home-landing-bandeau-searchbar">
						<input type="text" placeholder="Où ? Ville, code postal">
				...
				<img class="home-landing-background-image" src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2022/02/Home_Landing.jpg" alt="">
			</div>
        </section>
		<section>
		...
		<section>
			<div class="home-enseignants-container">
				<h2><span class="split-color-text">Notre réseau</span> d'enseignants</h2>
