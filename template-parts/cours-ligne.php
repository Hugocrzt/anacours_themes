...
<div>
    <main>
            ...
            <div class="home-landing-bandeau pilier-landing-bandeau">
				<div class="home-landing-bandeau-text-wrapper pilier-landing-adaptation">
					<div class="home-landing-bandeau-title-container">
						<h1>Cours <span class="split-color-text">en ligne</span></h1>
					</div>
					<h2 class="pillier-sous-titre">L'accompagnement scolaire en ligne</h2>
					<p>La plateforme Anacours online est un accompagnement éducatif qui profite aux élèves et à leur famille, depuis n’importe quel lieu d’habitation.</p>
					<a class="btn-demande-devis" href="#">Commencer dès maintenant</a>
				</div>
				<img class="home-landing-background-image pilier-landing-background-image-adaptation" src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2022/01/christin-hume-Hcfwew744z4-unsplash-scaled.jpg" alt="">
			</div>
        </section>
        <section>
			<div class="english-advantage-container">
				<div class="english-advantage-arguments-wrapper">
					<h2>Des ressources variées pour <span class="split-color-text">progresser rapidement</span></h2>
					<div class="english-advantage-arguments-space">
						...
						<div class="english-advantage-argument-item">
							<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2022/01/officiels_01.png" alt="">
							<p>Des contenus conformes aux programmes de l'Éducation Nationale</p>
						</div>
					</div>
				</div>
			</div>
        ...
        <section>
			<div class="explain-standard-container invert-dispo">
				<div class="explain-standard-text-wrapper">
					<h2><span class="split-color-text">Le tutorat en ligne</span> avec des enseignants</h2>
					<p>Le tutorat en ligne avec des enseignants Des enseignants sont présents en ligne pour accompagner chaque élève entre 17h et 20h du lundi au vendredi et même le dimanche (en option). Ils sont également disponibles par chat, audio ou vidéo pour répondre en direct aux questions des élèves.</p>
                    <a class="cta-yellow" href="#">Commencer dès maintenant</a>
                </div>
				<div class="explain-standard-image-wrapper">
					<div>
						<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2022/01/pexels-george-milton-7034720.jpg" alt="">
					</div>
				</div>
			</div>
        </section>
        ...
        <section>
			<div class="home-arguments-container online-adaptation">
