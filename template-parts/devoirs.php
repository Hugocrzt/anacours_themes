		...
		<section>
            <div class="home-landing-bandeau pilier-landing-bandeau">
				<div class="home-landing-bandeau-text-wrapper pilier-landing-adaptation">
					...
					<a class="cta-purple" href="https://www.anacours-musique.com/" target="_blank">Commencer dès maintenant</a>
				</div>
				<img class="home-landing-background-image pilier-landing-background-image-adaptation" src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2022/01/pexels-artem-podrez-6951552-scaled.jpg" alt="">
			</div>
        </section>
        <section>
			...
			<div class="explain-standard-container">
				<div class="explain-standard-text-wrapper">
					...
					<p>Le recrutement de nos intervenants requiert toute notre attention. Chaque candidat est systématiquement reçu en entretien individuel et sélectionné pour son aptitude à garder des enfants mais aussi pour ses qualités humaines. Nous garantissons que nos intervenants ont tous une expérience justifiée de la garde d’enfants et la plupart a passé des diplômes tels que l’AFPS (secouriste) ou le BAFA. Pour les missions concernant les sorties d’écoles des plus jeunes, nous privilégions bien sûr les profils professionnels de la petite enfance.</p>
                    <div class="notre-plus-block">
						<p>Notre plus</p>
						<p>Vous rencontrez l’intervenant lors du 1er cours avant de vous engager !</p>
					</div>
                </div>
