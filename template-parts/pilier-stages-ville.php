...
/*
    Template Name: Pilier-Stages-Ville
*/
		...
		<section>
            <div class="home-landing-bandeau">
				<div class="home-landing-bandeau-text-wrapper pilier-landing-adaptation">
					...
					<h2 class="pillier-sous-titre">Pour réviser et s'entrainer efficacement pendant les vacances !</h2>
            ...
            <div class="recrutement-post-container stage-intensif-adaptation">
                ...
                <div class="recrutement-post-wrapper">
                    <div class="recrutment-post-item">
                        ...
                        <p>Alios autem dicere aiunt multo etiam inhumanius praesidii adiumentique causa, non benevolentiae neque caritatis, amicitias esse expetendas; itaque, ut quisque minimum firmitatis haberet minimumque virium.</p>
        ...
        <section>
			<div class="container-bandeau-matiere">
				<div class="wrapperone-bandeau-matiere">
					<div>
						<h2>Au college et au lycée dans de <span class="split-color-text">nombreuses matières</span></h2>
						<p>Batnae municipium in Anthemusia conditum Macedonum manu priscorum ab Euphrate flumine brevi spatio disparatur, refertum mercatoribus opulentis, ubi annua sollemnitate prope Septembris.</p>
					</div>
					<div class="notre-plus-block">
						<p>Notre plus</p>
						<p>Humanitatisque deberet in actibus similia exitium humanitatisque stimulos illius erga obstinatum coniugem cum potius erga.</p>
					</div>
				</div>
        ...
        <section>
			<div class="standar-listing-container pilier-stages-adaptation">
				<div class="standar-listing-text-wrapper">
					<h2><span class="split-color-text">Tarifs</span> et condition</h2>
					<p>Post quorum necem nihilo lenius ferociens Gallus ut leo cadaveribus pastus multa huius modi scrutabatur. quae singula narrare non refert, me professione modum.</p>
                    <a class="cta-yellow" href="#">Commencer dès maintenant</a>
				</div>
				<div class="standar-listing-list-wrapper">
					<ul>
						<li>
							<p>Un service d'écoute et un dignostic précis des besoins</p>
						</li>
						<li>
							<p>Un service d'écoute et un dignostic précis des besoins</p>
						</li>
        ...
        <section>
			<div class="explain-standard-container invert-dispo">
				<div class="explain-standard-text-wrapper">
					<h2>Les stages prévus dans <span class="split-color-text">votre agence</span></h2>
					...
					<a class="cta-yellow" href="<?php echo esc_url( home_url( '/' ) ); ?>les-stages-intensifs-a-nice/">Voir les stages disponible à Nice</a>
				</div>
				<div class="explain-standard-image-wrapper">
					<div>
						<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2022/01/Nice-scaled.jpg" alt="">
					</div>
				</div>
			</div>
        </section>
			...
			<div class="home-enseignants-container pillier-adaptation">
				<div class="home-enseignants-wrapper">
					...
					<div class="home-enseignants-text">
						<h2>Des enseignants <span class="split-color-text">qualifiés et pédagogue</span></h2>
						<p>Constituendi autem sunt qui sint in amicitia fines et quasi termini diligendi. De quibus tres video sententias ferri, quarum nullam probo.</p>
