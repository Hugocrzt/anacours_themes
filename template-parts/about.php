            ...
            <div class="home-landing-bandeau about-adaptation">
				<div class="home-landing-bandeau-text-wrapper">
					...
					<div class="tophorizontal-landing-ctas-niveau-adaptation">
						...
						<a class="transparent-btn niveau-adaptation" href="<?php echo esc_url( home_url( '/' ) ); ?>stages-intensifs/">
							Stages intensifs 
							<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/12/icon-arrow-right.svg" alt="">
						</a>
						<a class="transparent-btn niveau-adaptation" href="<?php echo esc_url( home_url( '/' ) ); ?>cours-en-ligne/">
							Cours en ligne 
							<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/12/icon-arrow-right.svg" alt="">
						</a>
					</div>
        ...
        <section>
			<div class="explain-standard-container invert-dispo">
				...
				<div class="explain-standard-image-wrapper">
					<div>
						<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2022/01/TS5D5174.jpg" alt="">
					</div>
				</div>
			</div>
        </section>
        <section>
			<div class="explain-standard-container background-contain">
				<div class="explain-standard-text-wrapper">
					<h2><span class="split-color-text">Notre expertise</span> à votre service est unique</h2>
					<p>Chez Anacours chaque famille échange longuement avec nos conseillers pédagogiques. Ils mettent à disposition leur expertise et leur expérience afin que chaque élève puissiez bénéficiez de l’accompagnement scolaire le plus adapté à ses attentes.</p>
				</div>
				<div class="explain-standard-image-wrapper">
					<div>
