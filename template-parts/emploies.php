...
<div>
    <main>
        <section>
            <h1 class='center-title'>Pourquoi rejoindre Anacours ?</h1>
			<div class="explain-standard-container invert-dispo">
				<div class="explain-standard-text-wrapper">
					<h2>Devenir enseignant</h2>
					<p>Verum ad istam omnem orationem brevis est defensio. Nam quoad aetas M. Caeli dare potuit isti suspicioni locum, fuit primum ipsius pudore, deinde etiam patris diligentia disciplinaque munita. Qui ut huic virilem togam deditšnihil dicam hoc loco de me; tantum sit, quantum vos existimatis; hoc dicam.</p>
                    <a class="cta-yellow" href="<?php echo esc_url( home_url( '/' ) ); ?>recrutement/">Postuler</a>
                </div>
        ...
        <section>
			<div class="explain-standard-container">
				<div class="explain-standard-text-wrapper emploie-adaptation">
					<h2>Rejoindre nos équipes en agence</h2>
                    ...
                    <p>Verum ad istam omnem orationem brevis est defensio. Nam quoad aetas M.</p>
                    <a class="cta-yellow" target="_blank" href="https://carriere.anacours.com/">Postuler</a>
                </div>
				<div class="explain-standard-image-wrapper">
					<div>
						<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/10/leone-venter-VieM9BdZKFo-unsplash-scaled.jpg" alt="">
        ...
        <section>
			<div class="explain-standard-container invert-dispo">
				<div class="explain-standard-text-wrapper">
					<h2>Anacours et vous</h2>
					<p>Verum ad istam omnem orationem brevis est defensio. Nam quoad aetas M. Caeli dare potuit isti suspicioni locum, fuit primum ipsius pudore.</p>
					<a class="cta-transparent" href="<?php echo esc_url( home_url( '/' ) ); ?>qui-sommes-nous/">Mieux nous connaitre <img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/12/icon-arrow-right.svg" alt=""></a>
                    <a class="cta-transparent" href="<?php echo esc_url( home_url( '/' ) ); ?>qui-sommes-nous/">Découvrir nos valeurs <img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/12/icon-arrow-right.svg" alt=""></a>
				</div>
				<div class="explain-standard-image-wrapper">
					<div>
						<img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/10/leone-venter-VieM9BdZKFo-unsplash-scaled.jpg" alt="">
        ...
        <section>
            <div class="recrutement-video-container">
                <h2>Paroles de profs: nos enseignants témoignent</h2>
                <p>Alios autem dicere aiunt multo etiam inhumanius raesidii adiumentique causa, non benevolentiae neque caritatis, amicitias esse expetendas; itaque, ut quisque minimum firmitatis haberet minimumque virium, ita amicitias appetere maxime.</p>
                <div class="swiper-three">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="recrutement-video-wrapper">
        ...
        <section>
            <div class="explain-standard-container center-dispo">
                <h2>Lorem Ipsum</h2>
                <div>
                    <img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2021/12/Capture-décran-2021-12-20-à-09.55.38.png" alt="">
                </div>
            </div>
        </section>
		<section>
