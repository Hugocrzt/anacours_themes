...
class Menus {
	...
	public function register_menus() {
		register_nav_menus([
			'anacours-header-menu' => esc_html__( 'Header Menu', 'anacours' ),
			'lang-menu' => esc_html__( 'Select Lang', 'anacours' ),
			'contact-menu' => esc_html__( 'Contact', 'anacours' ),
			'legale-menu' => esc_html__( 'Legale', 'anacours' )
		]);
	}
